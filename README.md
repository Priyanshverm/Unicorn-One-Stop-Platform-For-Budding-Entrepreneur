...
```
git clone https://github.com/Priyanshverm/Unicorn
```
...
To test the application, you can use the following test accounts. The password for all accounts is **`password123`**.

| Name | Email | Position |
|------|-------|----------|
| Admin | admin@gmail.com | Admin |
| Priyansh Verma | priyanshvem11@gmail.com | Mentor |
| Apoorva Singh | apoorva@gmail.com | Counsellor |
| vrateen | vrateen@gmail.com | Validator |
| bhagyashree | Bhagyashree@gmail.com | Legal Advisor |
| smile | smile@gmail.com | StartUp |
| saanvi | saanvi@gmail.com | Funding Agent |
| Khushi | kk@gmail.com | Linkage Agent |
| New person | n@gmail.com | Advertisement Agent |
| Ross | ross@gmail.com | Job Seeker |
| New | new@gmail.com | *None* |
...
Priyansh Verma<br> 
[@Linkedin](https://linkedin.com/in/priyansh-verma-068139296)
<br>
[@Github](https://github.com/Priyanshverm)
<br>
...
<a id="bug"></a>
## 🐛 Bug Reporting
Feel free to [open an issue](https://github.com/Priyanshverm/Unicorn/issues) on GitHub if you find bugs.

<a id="feature-request"></a>
## ⭐ Feature Request
- Feel free to [open an issue](https://github.com/Priyanshverm/Unicorn/issues) on GitHub to add any additional features you feel could enhance this project.  
